...
import RiskTools from '../../components/risk/RiskTools';
    ...
    <div className="flex min-h-screen flex-col bg-[#080c14]">
      ...
      <main className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="flex items-center gap-2 border-b border-slate-800 pb-4">
          ...
          <div>
            <h1 className="text-lg font-bold text-white uppercase tracking-tight">Risk Mitigation Controls</h1>
            <p className="text-[10px] text-slate-500">Calculate size variables, monitor open position risk, and check daily loss limit thresholds.</p>
          </div>
        </div>

        {user && (
          <RiskTools trades={trades} currency="INR" />
        )}
